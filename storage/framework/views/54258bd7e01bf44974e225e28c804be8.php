    ...
    <div class="grid__container">
        <div class="grid">
            <div class="grid__item item__for_ad">
                ...
                <img class="about__svg" src=<?php echo e(asset("build/img/illustrations/Styles.svg")); ?>>
            </div>
            <div class="grid__item item__for_voice">
                ...
                <img class="about__svg" src=<?php echo e(asset("build/img/illustrations/Formats.svg")); ?>>
            </div>
            <div class="grid__item item__for_video">
                ...
                <img class="about__svg" src=<?php echo e(asset("build/img/illustrations/Versions.svg")); ?>>
            </div>
            <div class="grid__item item__styles">
                <div class="item__header">
                    <img src=<?php echo e(asset('build/img/dollar-icon.svg')); ?>>
                    <h2>Для рекламы</h2>
                </div>
                <br>
                <p>
            ...
            <div class="grid__item item__sound">
                <div class="item__header">
                    <img src=<?php echo e(asset('build/img/music-icon.svg')); ?>>
                    <h2>Бит под голос</h2>
                </div>
                <br>
                <p>
            ...
            <div class="grid__item item__rights">
                <div class="item__header">
                    <img src=<?php echo e(asset('build/img/play-icon.svg')); ?>>
                    <h2>Фон для видео</h2>
                </div>
                <br>
                <p>
                        ...
                        <div class="message from__bot">
                            <div class="message__bot message__player">
                                <audio controls id="audio">
                                    <source src="<?php echo e(asset("build/audio/examplebeat3.wav")); ?>" type="audio/mpeg">
                                    Your browser does not support the audio element.
                                </audio>
                                <button id="play-pause" class="btn-round">
                                    <img id="play-pause-icon" src=<?php echo e(asset("build/img/play.png")); ?> alt="Play">
                                </button>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ranco\Documents\GitHub\simple-landing-page\resources\views/index.blade.php ENDPATH**/ ?>